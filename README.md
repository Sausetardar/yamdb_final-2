...
**Рабочий проект находится по адресу [https://www.yamdb.praktikum.ga/](https://www.yamdb.praktikum.ga/)**
...
Для работы с данными применены фреймворки **[Django](https://www.djangoproject.com/)**, **[Django rest framework](https://www.django-rest-framework.org/)**, в том числе регистрация осуществляется через Simple JWT.
